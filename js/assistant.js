...
const responses = {
    "من هو خباب": {
        type: 'profile',
        content: {
            text: "خباب سيف الدين هو طالب هندسة شبكات، شغوف بتطوير البرمجيات وهندسة الشبكات. متخصص في تصميم المواقع وإدارة الشبكات.",
            image: "https://www2.0zz0.com/2025/03/18/05/915054445.png",
            details: [
                { icon: "fas fa-graduation-cap", text: "طالب هندسة شبكات" },
    ...
    "دراسته": {
        ...
        content: {
            ...
            currentLevel: "طالب هندسة شبكات",
            details: "يدرس خباب حالياً هندسة الشبكات، ويتميز بالتركيز على دراسته الأكاديمية مع تطوير مهاراته في مجالات البرمجة والتقنية بشكل متوازي.",
    ...
    "الشهادات": {
        ...
        content: {
            ...
            certificates: [
                ...
                {
                    name: "التطوع الصحي المجتمعي",
                    provider: "وزارة الصحة السعودية",
                    description: "شهادة معتمدة في البرنامج التدريبي للتطوع الصحي المجتمعي",
    ...
    "شهادة التطوع الصحي": {
        type: 'single-certificate',
        content: {
            name: "شهادة البرنامج التدريبي التطوع الصحي المجتمعي",
            provider: "وزارة الصحة السعودية",
            description: "نعم، حاصل على شهادة معتمدة في البرنامج التدريبي للتطوع الصحي المجتمعي من وزارة الصحة السعودية",
            icon: "fas fa-hospital-user",
            date: "2024",
            topics: ["التطوع الصحي", "الرعاية الصحية المجتمعية", "الإسعافات الأولية", "التوعية الصحية"]
        }
    },
    "منصة عافيتي": {
...
const keywordMap = {
    ...
    // شهادة التطوع الصحي المجتمعي
    'شهادة التطوع الصحي': 'شهادة التطوع الصحي',
    'التطوع الصحي': 'شهادة التطوع الصحي',
    'تطوع صحي': 'شهادة التطوع الصحي',
    'شهادة تطوع صحي': 'شهادة التطوع الصحي',
    'برنامج التطوع الصحي': 'شهادة التطوع الصحي',
    'البرنامج التدريبي التطوع الصحي': 'شهادة التطوع الصحي',
    'البرنامج التدريبي للتطوع الصحي': 'شهادة التطوع الصحي',
    'تطوع صحي مجتمعي': 'شهادة التطوع الصحي',
    'شهادة مجتمعية': 'شهادة التطوع الصحي',
    'شهادة صحية مجتمعية': 'شهادة التطوع الصحي',
    'شهادة التطوع الصحي المجتمعي': 'شهادة التطوع الصحي',
    'البرنامج التدريبي للتطوع الصحي المجتمعي': 'شهادة التطوع الصحي',
...
function findBestMatch(input) {
    ...
    if (cleanInput.includes('شهادة') || cleanInput.includes('حاصل على')) {
        ...
        if (cleanInput.includes('صحة') || cleanInput.includes('طبية') || cleanInput.includes('وزارة الصحة')) {
            if (cleanInput.includes('تطوع') || cleanInput.includes('مجتمعي')) {
                return 'شهادة التطوع الصحي';
            } else {
                return 'شهادة وزارة الصحة';
            }
        }
        if (cleanInput.includes('هلال') || cleanInput.includes('تطوع')) {
            if (cleanInput.includes('صحي') || cleanInput.includes('مجتمعي')) {
                return 'شهادة التطوع الصحي';
            } else {
